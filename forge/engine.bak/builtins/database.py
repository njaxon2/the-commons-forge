...
DATABASE_REGISTRY: Dict[str, Dict[str, Any]] = {
    'forge_database':  {'func': forge_database,  'section': 'database', 'desc': 'Connect to database'},
    'forge_close_db':  {'func': forge_close_db,  'section': 'database', 'desc': 'Close database connection'},
    'forge_exec':      {'func': forge_exec,      'section': 'database', 'desc': 'Execute SQL statement'},
    'forge_fetch':     {'func': forge_fetch,      'section': 'database', 'desc': 'Fetch query results as struct'},
    'forge_insert':    {'func': forge_insert,    'section': 'database', 'desc': 'Insert rows into table'},
    'forge_update':    {'func': forge_update,    'section': 'database', 'desc': 'Update rows in table'},
    'forge_sqlread':   {'func': forge_sqlread,   'section': 'database', 'desc': 'Read table into struct'},
    'forge_sqlwrite':  {'func': forge_sqlwrite,  'section': 'database', 'desc': 'Write data to table'},
}
