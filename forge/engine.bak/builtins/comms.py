...
COMMS_REGISTRY: Dict[str, Dict[str, Any]] = {
    'qammod':       {'func': qammod,       'section': 'comms', 'desc': 'QAM modulation'},
    'qamdemod':     {'func': qamdemod,     'section': 'comms', 'desc': 'QAM demodulation'},
    'pskmod':       {'func': pskmod,       'section': 'comms', 'desc': 'PSK modulation'},
    'pskdemod':     {'func': pskdemod,     'section': 'comms', 'desc': 'PSK demodulation'},
    'fskmod':       {'func': fskmod,       'section': 'comms', 'desc': 'FSK modulation'},
    'fskdemod':     {'func': fskdemod,     'section': 'comms', 'desc': 'FSK demodulation'},
    'awgn':         {'func': awgn,         'section': 'comms', 'desc': 'Add white Gaussian noise'},
    'rayleighchan': {'func': rayleighchan, 'section': 'comms', 'desc': 'Rayleigh fading channel'},
    'ricianchan':   {'func': ricianchan,   'section': 'comms', 'desc': 'Rician fading channel'},
    'convenc':      {'func': convenc,      'section': 'comms', 'desc': 'Convolutional encoder'},
    'vitdec':       {'func': vitdec,       'section': 'comms', 'desc': 'Viterbi decoder'},
    'biterr':       {'func': biterr,       'section': 'comms', 'desc': 'Bit error count and rate'},
    'symerr':       {'func': symerr,       'section': 'comms', 'desc': 'Symbol error count and rate'},
    'berawgn':      {'func': berawgn,      'section': 'comms', 'desc': 'Theoretical BER for AWGN'},
    'eyediagram':   {'func': eyediagram,   'section': 'comms', 'desc': 'Eye diagram data'},
    'scatterplot':  {'func': scatterplot,  'section': 'comms', 'desc': 'I/Q scatter data'},
    'huffmandict':  {'func': huffmandict,  'section': 'comms', 'desc': 'Build Huffman dictionary'},
    'huffmanenco':  {'func': huffmanenco,  'section': 'comms', 'desc': 'Huffman encode'},
    'huffmandeco':  {'func': huffmandeco,  'section': 'comms', 'desc': 'Huffman decode'},
}
