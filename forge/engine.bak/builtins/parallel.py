...
PARALLEL_REGISTRY: Dict[str, Dict[str, Any]] = {
    'forge_parpool':       {'func': forge_parpool,       'section': 'parallel', 'desc': 'Create worker pool'},
    'forge_delete_pool':   {'func': forge_delete_pool,   'section': 'parallel', 'desc': 'Close worker pool'},
    'forge_gcp':           {'func': forge_gcp,           'section': 'parallel', 'desc': 'Get current pool'},
    'forge_parfor_helper': {'func': forge_parfor_helper, 'section': 'parallel', 'desc': 'Parallel map over items'},
    'forge_parfeval':      {'func': forge_parfeval,      'section': 'parallel', 'desc': 'Async function evaluation'},
    'forge_fetchOutputs':  {'func': forge_fetchOutputs,  'section': 'parallel', 'desc': 'Get async result'},
    'forge_spmd_helper':   {'func': forge_spmd_helper,   'section': 'parallel', 'desc': 'SPMD execution'},
    'forge_distributed':   {'func': forge_distributed,   'section': 'parallel', 'desc': 'Distribute array to workers'},
    'forge_gather':        {'func': forge_gather,        'section': 'parallel', 'desc': 'Gather distributed array'},
}
