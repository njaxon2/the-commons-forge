...
FINANCIAL_REGISTRY: Dict[str, Dict[str, Any]] = {
    'pvfix':     {'func': pvfix,     'section': 'financial', 'desc': 'Present value of fixed payments'},
    'fvfix':     {'func': fvfix,     'section': 'financial', 'desc': 'Future value of fixed payments'},
    'npv':       {'func': npv,       'section': 'financial', 'desc': 'Net present value'},
    'irr':       {'func': irr,       'section': 'financial', 'desc': 'Internal rate of return'},
    'rate':      {'func': rate,      'section': 'financial', 'desc': 'Solve for interest rate'},
    'nper':      {'func': nper,      'section': 'financial', 'desc': 'Number of periods'},
    'pmt':       {'func': pmt,       'section': 'financial', 'desc': 'Payment per period'},
    'bndprice':  {'func': bndprice,  'section': 'financial', 'desc': 'Bond clean price'},
    'bndyield':  {'func': bndyield,  'section': 'financial', 'desc': 'Bond yield to maturity'},
    'cfamounts': {'func': cfamounts, 'section': 'financial', 'desc': 'Bond cash-flow amounts'},
    'accrfrac':  {'func': accrfrac,  'section': 'financial', 'desc': 'Accrued interest fraction'},
    'blsprice':  {'func': blsprice,  'section': 'financial', 'desc': 'Black-Scholes call/put price'},
    'blsimpv':   {'func': blsimpv,   'section': 'financial', 'desc': 'Black-Scholes implied volatility'},
    'blsdelta':  {'func': blsdelta,  'section': 'financial', 'desc': 'Black-Scholes delta'},
    'blsgamma':  {'func': blsgamma,  'section': 'financial', 'desc': 'Black-Scholes gamma'},
    'blsvega':   {'func': blsvega,   'section': 'financial', 'desc': 'Black-Scholes vega'},
    'blstheta':  {'func': blstheta,  'section': 'financial', 'desc': 'Black-Scholes theta'},
    'blsrho':    {'func': blsrho,    'section': 'financial', 'desc': 'Black-Scholes rho'},
    'frontcon':  {'func': frontcon,  'section': 'financial', 'desc': 'Efficient frontier (analytic)'},
    'portopt':   {'func': portopt,   'section': 'financial', 'desc': 'Mean-variance portfolio optimisation'},
    'disc2cont': {'func': disc2cont, 'section': 'financial', 'desc': 'Discrete to continuous rate'},
    'cont2disc': {'func': cont2disc, 'section': 'financial', 'desc': 'Continuous to discrete rate'},
    'ret2tick':  {'func': ret2tick,  'section': 'financial', 'desc': 'Returns to price series'},
    'tick2ret':  {'func': tick2ret,  'section': 'financial', 'desc': 'Price series to returns'},
    'portsim':   {'func': portsim,   'section': 'financial', 'desc': 'Monte Carlo portfolio simulation'},
}
