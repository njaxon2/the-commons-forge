...
CONTROL_REGISTRY = {
    ...
    'tfdata': forge_tfdata,
    'ssdata': forge_ssdata,
    'zpkdata': forge_zpkdata,
    'minreal': forge_minreal,
    # --- System Interconnection ---
    'series': forge_series,
    'parallel': forge_parallel,
    'feedback': forge_feedback,
    'connect': forge_connect,
    'append': forge_append,
    'blkdiag_sys': forge_blkdiag_sys,
    # --- Time Response ---
    'step': forge_step,
    'impulse': forge_impulse,
    'lsim': forge_lsim,
    'initial': forge_initial,
    'stepinfo': forge_stepinfo,
    # --- Frequency Response ---
    'bode': forge_bode,
    'nyquist': forge_nyquist,
    'nichols': forge_nichols,
    'margin': forge_margin,
    'bandwidth': forge_bandwidth,
    'evalfr': forge_evalfr,
    'freqresp': forge_freqresp,
    # --- Stability & Analysis ---
    'pole': forge_pole,
    'zero': forge_zero,
    'dcgain': forge_dcgain,
