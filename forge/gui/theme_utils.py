...
def detect_palette():
    ...
    Returns a dict of color keys. Falls back to dark theme defaults.
    """
    try:
        ...
        # Check main window for stored theme name first
        ...
        # Fall back to QSS content matching (check bg0+bg1 combo)
...
def is_light_theme():
    ...
    p = detect_palette()
    return p.get("bg0", "#1e1e2e") == "#f8f9fc"
