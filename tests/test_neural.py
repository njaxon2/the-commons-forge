...
class TestNetworkCreation:
    def test_feedforwardnet_creation(self):
        ...
        feedforwardnet = _fn('forge_feedforwardnet')
...
class TestMetrics:
    def test_mse_metric_computation(self):
        ...
        mse_metric = _fn('forge_mse_metric')
